...
return declare( 'CanvasSubtracks.View.TrackList.FacetedSubtracks', null,
   {
   ...
   constructor: function(args) {
       ...
       this.renameFacets = args.renameFacets;
...
//        document.body );
        ...
        //     { region: 'top',
        //       id: "faceted_subtracksel_top",
        //       content: '<div class="title">Select Subtracks</div> '
...
//               rowSelector: '20px',
    ...
    renderTextFilter: function( parent ) {
        ...
        this.textFilterInput = dojo.create(
            ...
            { type: 'text',
              size: 40,
              disabled: false, // disabled until shown
...
//            'My Tracks', ['Currently Active', 'Recently Used'] );
    ...
    __updateFacetControl: function( facetName ) {
